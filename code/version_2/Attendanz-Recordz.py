"""
All Copyrights Reserved by Attendanz Recordz 2024

Designed and Programmed by Sanjay Kumar,

Date Created : 03 December 2023 | Last Updated : july 12, 2024
"""
...
def about_button():
    ...
    if about_button:
        ...
        tk.Label(about_win, text="Last Updated: 03 December 2023").place(x=0, y=100)
        tk.Label(about_win, text="Version: 1.0").place(x=0, y=130)
        tk.Label(
            about_win, text="Compatible with: Mac Os 10.1+ & Windows 7 and above"
        ).place(x=0, y=160)
        tk.Label(about_win, text="© Designed & Programmed by Sanjay Kumar").place(x=0, y=190)
...
© All Copyrights Reserved by Attendanz Recordz - 2023
""",
        ).place(x=75, y=380)
...
def save_pdf():
    if save_pdf:
        ...
        copyright_txt = [
            ...
            "© Attendanz Recordz, 2024",
            "Designed & Programmed by Sanjay kumar",
            "GitHub: @Devsanjay12",
        ]
...
# ----- Me! -----
tk.Label(
    root, text="© Designed & Programmed by Sanjay Kumar, GitHub: @Devsanjay12"
).place(x=350, y=690)
